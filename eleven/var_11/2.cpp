...
int main(void) {
    ...
    // переменная firstPositive не должна быть равна числу, входящему в промежуток от 0 до size
    ...
    for (int i = 0; i < (size - lastPositive); i++) // от 0 до количества элементов между последним положительным и концом массива
